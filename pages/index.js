    ...
    <Layout>
      <div className="md:w-4/5 xl:w-3/5 mx-auto mb-32">
        {url ? (<>
          ...
          ><span className='font-bold text-red-700 text-4xl uppercase'>Tu URL es :</span> {`${process.env.frontendURL}/enlaces/${url}`}</p>
          <button
                type="button"
                className="bg-red-500 w-full uppercase text-white font-bold uppercase p-2 hover:bg-gray-900 mt-10"
